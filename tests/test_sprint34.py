...
def test_control_center_resets_active_section_on_close():
    ...
    src = open(pathlib.Path(__file__).parent.parent / 'static' / 'panels.js', encoding='utf-8').read()
...
def test_control_center_tab_highlight_on_open():
    ...
    css = open(pathlib.Path(__file__).parent.parent / 'static' / 'style.css', encoding='utf-8').read()
